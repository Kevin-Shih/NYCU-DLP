...
from models.acwgan_gp import Discriminator, Discriminator3, Discriminator4, Discriminator4a, Generator, Generator3, Generator4, Generator4a
            ...
            with tqdm(total=len(self.train_loader), ncols=100) as pbar:
                ...
                while iterator < len(self.train_loader):
                    ...
                    while d_iter < self.diter and iterator < len(self.train_loader):
                        ...
                        d_loss:Tensor = (fake_loss - real_loss) + self.lambda_ac_d * aux_loss
                        d_loss.backward()
                        self.optimD.step()
                        for p in self.discriminator.parameters():
    ...
    def predict(self, test_loader):
        ...
        with torch.no_grad():
            for cond in test_loader:
                ...
                score = eval_model.eval(fake_images, cond)
...
if __name__ == '__main__':
    ...
    if not args.inference:
        ...
        trainer.generator.load_state_dict(torch.load('../ckpt/acwgangp/gen_test.pth'))
