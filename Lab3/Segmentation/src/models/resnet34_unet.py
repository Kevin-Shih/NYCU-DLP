...
class ResNet34_Unet(nn.Module):
    def __init__(self):
        ...
        self.up1 = nn.ConvTranspose2d(768, 768, kernel_size= 2, stride= 2)
        self.dconv1 = ConvBlock(768, 32)
        self.up2 = nn.ConvTranspose2d(288, 288, kernel_size= 2, stride= 2)
        self.dconv2 = ConvBlock(288, 32)
        self.up3 = nn.ConvTranspose2d(160, 160, kernel_size= 2, stride= 2)
        self.dconv3 = ConvBlock(160, 32)
        self.up4 = nn.ConvTranspose2d(96, 96, kernel_size= 2, stride= 2)
        self.dconv4 = ConvBlock(96, 32)
