...
class Test_model(VAE_Model):
    ...
    def val_one_step(self, img, label, idx=0):
        ...
        for i in range(1, self.val_vi_len):
            ...
            prev_img = self.Generator(fused_f)
            decoded_frame_list.append(prev_img.cpu())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_path', '-ckpt', type=str,   default=None, help="The path of your checkpoints")   
